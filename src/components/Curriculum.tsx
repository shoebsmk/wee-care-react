        ...
        <section id="curriculum" className="py-24 bg-slate-900 text-white">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-sm font-bold text-orange-400 uppercase tracking-widest mb-4">What We Teach</h2>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {schoolInfo.curriculum.map((item, i) => (
                        <div key={i} className="bg-white/5 border border-white/10 p-6 rounded-2xl flex flex-col items-center text-center">
                            <div className="w-10 h-10 bg-orange-600/20 text-orange-400 rounded-full flex items-center justify-center mb-4">
                                <Check size={20} />
                            </div>
                ...
                <div className="mt-12 bg-white/5 p-8 rounded-3xl border border-white/10 text-center">
                    <h4 className="text-orange-400 font-bold mb-4 uppercase text-xs tracking-widest">Extra Activities</h4>
